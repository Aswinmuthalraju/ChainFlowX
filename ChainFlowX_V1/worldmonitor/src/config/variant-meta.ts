...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'ChainFlowX - Supply Chain Contagion Intelligence Dashboard',
    description: 'Real-time supply chain contagion intelligence dashboard with live news, markets, infrastructure monitoring, and logistics tracking. Trade resilience in one view.',
    keywords: 'supply chain intelligence, logistics dashboard, world news, market data, freight tracking, maritime monitoring, undersea cables, trade barriers, real-time monitoring, situation awareness, OSINT, flight tracking, AIS ships, earthquake monitor, protest tracker, power outages, oil prices, trade resilience, polymarket predictions',
    url: 'https://www.chainflowx.app/',
    siteName: 'ChainFlowX',
    shortName: 'ChainFlowX',
    subject: 'Real-Time Supply Chain Contagion and Trade Resilience',
    classification: 'Supply Chain Dashboard, Logistics Intelligence, News Aggregator',
    categories: ['news', 'productivity'],
    features: [
      'Real-time news aggregation',
      'Stock market tracking',
      'Logistics flight monitoring',
      'Ship AIS tracking',
      'Earthquake alerts',
      'Protest tracking',
      'Power outage monitoring',
      'Oil price analytics',
      'Trade barrier monitoring',
      'Prediction markets',
  ...
  happy: {
    ...
    url: 'https://happy.chainflowx.app/',
  ...
  finance: {
    ...
    url: 'https://finance.chainflowx.app/',
  ...
  commodity: {
    ...
    url: 'https://commodity.chainflowx.app/',
