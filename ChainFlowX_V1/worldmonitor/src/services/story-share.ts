...
export const shareTexts = {
  ...
  linkedin: (data: StoryData) =>
    ...
    `\nData via ChainFlowX - Supply Chain Contagion Intelligence`,
...
export function getShareUrls(data: StoryData): Record<string, string> {
  ...
  return {
    ...
    reddit: `https://reddit.com/submit?url=${encodeURIComponent(url)}&title=${encodeURIComponent(`${data.countryName} Supply Chain Brief - ChainFlowX`)}`,
