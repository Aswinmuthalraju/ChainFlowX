...
const SETTINGS_KEY_PREFIXES: readonly string[] = [
  ...
  'chainflowx-live-channels',
  'chainflowx-active-channel',
  'chainflowx-runtime-feature-toggles',
  'cfx-globe-render-scale',
  'cfx-live-streams-always-on',
  'chainflowx-webcam-prefs',
  'cfx-map-theme:',
  'map-height',
  'map-pinned',
...
export function exportSettings(): void {
  ...
  const exportData: ExportedSettings = {
    ...
    variant: localStorage.getItem('chainflowx-variant') || 'full',
    data,
  };
  ...
  a.download = `chainflowx-settings-${ts}.json`;
